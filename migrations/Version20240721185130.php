 ...
 */
final class Version20240721185130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE recurring_operation_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE pdf (id INT NOT NULL, owner_id INT NOT NULL, mensuel_details BOOLEAN NOT NULL, names BOOLEAN NOT NULL, entite_name TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_EF0DB8C7E3C61F9 ON pdf (owner_id)');
        $this->addSql('CREATE TABLE recurring_operation (id INT NOT NULL, owner_id INT NOT NULL, repetition TEXT NOT NULL, adding_type TEXT NOT NULL, first_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, last_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, name TEXT NOT NULL, montant NUMERIC(15, 2) NOT NULL, type TEXT NOT NULL, occurences TEXT DEFAULT NULL, wanted_to_remove_all BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_73A53A527E3C61F9 ON recurring_operation (owner_id)');
        $this->addSql('CREATE TABLE transaction (id INT NOT NULL, category_id INT DEFAULT NULL, payment_id INT DEFAULT NULL, owner_id INT NOT NULL, name TEXT NOT NULL, montant NUMERIC(15, 2) NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, type TEXT NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE recurring_operation_id_seq CASCADE');
